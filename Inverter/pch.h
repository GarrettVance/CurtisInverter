...
//     
//    Note: You must #include collection.h to use types in the Platform::Collections namespace: 
//   
//    https://docs.microsoft.com/en-us/cpp/cppcx/platform-collections-namespace?view=vs-2017
//         
